#!/bin/bash
#SBATCH --job-name=mu_Cv
#SBATCH --output=./logs/mu_Cv_%j.out
#SBATCH --error=./logs/mu_Cv_%j.err
...
python main_qm9.py --exp_name single_cfg_mu_Cv \
                   --model egnn_dynamics \
                   --lr 2e-4 \
                   --nf 192 \
                   --n_layers 9 \
                   ...
                   --class_drop_prob 0.1 \
                   --dataset_portion 0.5 \
                   --resume outputs/single_cfg_mu_Cv \
